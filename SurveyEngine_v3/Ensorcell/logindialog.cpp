 ...
 *
 * Initializes QLabel, QLineEdit, QPushButtons (etc)
 */
void LoginDialog::initialize()
{

    ensorcellLogo = new QLabel(this);
    ensorcellLogo->setPixmap(QPixmap(":/images/images/ensorcell3.png"));
    ...
    errorIconUs->setPixmap(QPixmap(":/images/images/error.png"));
    errorIconUs->hide();
    errorIconEm = new QLabel(this);
    errorIconEm->setPixmap(QPixmap(":/images/images/error.png"));
    errorIconEm->hide();
    errorIconLo = new QLabel(this);
    errorIconLo->setPixmap(QPixmap(":/images/images/error.png"));
    errorIconLo->hide();
    ...
    errorIconPass->setIcon(QIcon(":/images/images/error.png"));
    ...
    passRestHolder->setPixmap(QPixmap(":/images/images/passRestictions3.png"));
    passRestHolder->hide();
 ...
 *
 * Sets text to the QLabels and QPushButtons
 */
 ...
 *
 * Sets the absolute position of each
...
{
    //logo placement
    ensorcellLogo->setGeometry(275,20,250,150);
 ...
 *
 * Connects each QPushButton or QLineEdit
 ...
 * \param check
 *
 * Displays or hides the password text
 * for the login area on the left
 */
 ...
 *
 * Displays or hides the password text
 * for the sign up area on the left
 */
 ...
 *
 * Validates the format of the password created
 */
 ...
 * email QLineEdit to alert the
 * user it is wrong or right
 */
 ...
 *
 * Emits a signal the login is completed
 */
 ...
 *
 * Emits a signal the logn is completed
 */
